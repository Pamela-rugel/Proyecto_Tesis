...
export default function SemanticaPage() {
  ...
  const mutation = useMutation({
    mutationFn: () => buscarSemantica(consulta, topN),
            ...
            <table className="min-w-full text-sm">
              <thead className="bg-slate-50">
                <tr>
                  ...
                  <th className="text-left px-3 py-2 font-medium text-xs uppercase tracking-wide text-slate-500">Perfil</th>
              ...
              <tbody>
                {mutation.data.resultados.map((r) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2">{r.perfil_nombre ?? "-"}</td>
                    <td className="px-3 py-2">{r.tipo_empleado ?? "-"}</td>
                    <td className="px-3 py-2">{r.cargo_actual ?? "-"}</td>
