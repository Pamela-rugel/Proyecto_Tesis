...
`08_dashboard.ipynb` para el detalle de la preparación de datos y las decisiones de diseño (DEC-003
...
- `08_dashboard.ipynb` — prepara y valida los datasets consolidados en `data/dashboard/`, y
...
```
d:\Proyecto_Tesis\.venv\Scripts\streamlit run notebooks\08_dashboard\app.py --server.address localhost
```
...
Si cambian los resultados de `06_clustering` o `07_embeddings`, vuelve a ejecutar
`08_dashboard.ipynb` completo (con el kernel "Proyecto Tesis - Dashboard (.venv)") para regenerar
